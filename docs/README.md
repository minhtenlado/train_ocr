...
│   ├── best_square_ocr_pro.pth  # Best model checkpoint
│   └── best.pt           # Alternative model format
├── data/                 # Training data
│   ├── train.csv         # Training annotations
│   └── dataset/          # Dataset directory (images and labels)
├── images/               # Sample images & diagrams
│   └── training_pipeline.png  # Training pipeline diagram
├── tests/                # Test files
